...
const PROJECTS = [
  ...
  },
  {
    ...
    desc: "Semantic grounding + lightweight LB-scSE self-distilled ResNet for small and occluded traffic signs. Achieves 68.52% mAP@50 on DINO&GTSRBv1 while reducing model size by 10x for real-time autonomous-driving deployment.",
    img: "/img/gdino_tfsign_overview.png",
    url: "https://www.sciencedirect.com/science/article/pii/S2215098625000837",
    year: "2025",
    accent: "#E4582E",
    tint: "#FFF1E9",
    tags: ["Semantic grounding", "LB-scSE", "Edge"],
  },
  {
    name: "PIXEL PLANE",
    label: "Generative Data Engine",
    desc: "Generative-AI Streamlit app that scales 100 images into 10,000 synthetic samples for autonomous-vehicle training, with text-guided detection + SAM + PowerPaint + Stable Video Diffusion.",
